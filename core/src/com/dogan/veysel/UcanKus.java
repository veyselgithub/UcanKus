...
public class UcanKus extends ApplicationAdapter {
	...
	public void render () {
		...
		if(state==1){
			...
			font1.draw(batch,"Oyun Bitti!",Gdx.graphics.getWidth()/04,Gdx.graphics.getHeight()/2);
			...
			font1.draw(batch,"Basla!",Gdx.graphics.getWidth()/3,Gdx.graphics.getHeight()/2);
